...
Q1A_TRANSMATRIX = np.array([[1/5., 2/7., 0., 0., 0., 0., 0., 2/13., 0.         ],
                            ...
                            [2/5., 0., 2/9., 0., 2/11., 2/7., 2/7., 1/13., 2/3.],
                            [0., 0., 0., 0., 0., 0., 0., 2/13., 1/3.           ]])

VALUES, VECTORS = np.linalg.eig(Q1A_TRANSMATRIX)
...
if __name__ == '__main__':
    #print( is_stochastic( Q1A_TRANSMATRIX ) )
    #print(VECTORS[:, 0])
    #print(VALUES[0])
