...
Q1C1_TRANSMATRIX = np.array([[1/7., 2/7., 0., 0., 0., 0., 0., 2/13., 2/5.      ],
...
Q1C2_TRANSMATRIX = np.array([[1/5., 2/7., 0., 0., 0., 0., 0., 2/11., 0.        ],
                            [2/5., 1/7., 2/9., 2/7., 0., 0., 0., 0., 0.        ],
                            [0., 2/7., 1/9., 2/7., 2/9., 0., 0., 2/11., 0.     ],
                            [0., 2/7., 2/9., 1/7., 2/9., 0., 0., 0., 0.        ],
                            [0., 0., 2/9., 2/7., 1/9., 2/7., 2/7., 0., 0.      ],
                            [0., 0., 0., 0., 2/9., 1/7., 2/7., 2/11., 0.       ],
                            [0., 0., 0., 0., 2/9., 2/7., 1/7., 2/11., 0.       ],
                            [2/5., 0., 2/9., 0., 0., 2/7., 2/7., 1/11., 2/3.   ],
                            [0., 0., 0., 0., 0., 0., 0., 2/11., 1/3.           ]])

VALUES1, VECTORS1 = np.linalg.eig(Q1C1_TRANSMATRIX)
VALUES2, VECTORS2 = np.linalg.eig(Q1C2_TRANSMATRIX)
...
def display_probability(eig_vals, eig_vecs):
    """Takes the Eigen vectors and values1 of a transition
...
if __name__ == '__main__':
    #print( is_stochastic( Q1C1_TRANSMATRIX ) )
    #print(VECTORS1[:, 0])
    #print(VALUES1[0])
    print( display_probability(VALUES1, VECTORS1) )